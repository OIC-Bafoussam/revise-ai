    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto grid md:grid-cols-3 gap-8 text-center">
        <div className="p-6 bg-white rounded-2xl shadow">
          <img src="/images/kana.png" alt="Feature 1" className="mx-auto mb-4 h-60" />
        ...
        <div className="p-6 bg-white rounded-2xl shadow">
          <img src="/images/k.png" alt="Feature 2" className="mx-auto mb-4 h-60" />
        ...
        <div className="p-6 bg-white rounded-2xl shadow">
          <img src="/images/ka.png" alt="Feature 3" className="mx-auto mb-4 h-60" />
